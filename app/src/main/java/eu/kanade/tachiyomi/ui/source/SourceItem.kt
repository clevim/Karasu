...
class SourceItem(val source: CatalogueSource, header: LangItem? = null, val isPinned: Boolean? = null) :
    ...
    override fun isSwipeable(): Boolean {
        return Injekt.get<UiPreferences>().enableSourceSwipeAction().get() && source.id != LocalSource.ID && header != null && header.code != SourcePresenter.LAST_USED_KEY && header.code != SourcePresenter.RECOMMENDATIONS_KEY
    }
